...
/*
 * This is also used for fresh cached CIMD rows. Cached metadata avoids an HTTP
 * fetch, but authorization still depends on the current client_id hostname being
 * safe to use according to the same egress policy.
 */
